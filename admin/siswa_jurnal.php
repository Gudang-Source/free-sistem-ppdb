...
<form class="form-inline well" name="form1" method="get" action="">
	<input type="hidden" name="hal" value="siswa_jurnal"/>
...
<a href="#" class="btn btn-primary btn-sm" onClick="NewWin=window.open('print.php?cetak=siswa_cetak&jurusan_id=<?php echo $colname_rec_siswa_tampil; ?>','NewWin','toolbar=no,status=no,width=800,height=500,scrollbars=yes');"><span class="glyphicon glyphicon-print"></span> Cetak</a>
